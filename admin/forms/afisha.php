...
<table align="center" width="780px">
 ...
 <tr>
  <td>
   ...
   <form method="post" action="dob.php?afisha=dob&gal=radius&prewi=dobi" enctype="multipart/form-data">
    <table align="center" width="100%" cellpadding="0" cellspacing="0">
     <tr>
       <td><font class="shrift-stock">Добавить фотографию для события(если есть):</font></td>
	 ...
	 <tr><td colspan="3" height="30px"><a href="dob.php?afisha=click&crop=no">Пропустить загрузку изображения</a></td></tr>
    </table>  
   </form>
 <?
if ($_GET['prewi']=="dobi")
     {
      $localhost = "/home/host1241978/taishettoday.ru/htdocs/www/admin/photos/";
      $path_img = "photos/";
...
?>   
   ...
   <tr><td align="center"><img id="photo" src="<? echo $new_filename_i; ?>" alt="" title="" style="margin: 0 0 10 0px; color:#6c6c6c;" vspace="10" border="2" />
        <form action="dob.php?afisha=click&crop=yes" method="post">
...
<? if($_GET['crop']=="yes"){ $new_filename = "admin/".$new_filename; include "forms/form_afisha.php"; }    
if($_GET['crop']=="no"){ $new_filename = "no"; include "forms/form_afisha.php"; } ?>